...
const slides = [
  {
    ...
    title: 'Handcrafted',
    subtitle: 'Eco-Friendly Collection 2026',
    description: 'Discover our curated collection of sustainable, earth-friendly products...',
    image: '/necklace.jpeg',
  },
  {
    id: '2',
    title: 'Traditional',
    subtitle: 'Tribal Art Collection',
    description: 'Experience the beauty of traditional tribal paintings and artwork...',
    image: '/imgCourousel1.jpeg',
  },
  {
    id: '3',
    title: 'Artisan',
    subtitle: 'Brass & Pottery Collection',
    description: 'Explore our handmade brass artifacts and ceramic pottery...',
    image: '/tribal-art-statues-stockcake.webp',
  },
];
        ...
        {slides.map((slide, index) => (
          ...
          >
            <div className="relative h-full w-full">
              ...
              {/* Image with fade from right to left */}
              <div className="absolute inset-0">
                <div className="relative h-full w-full">
                  ...
                  {/* Fade mask: solid right → transparent left */}
                  <div
                    className="absolute inset-0"
                    style={{
                      background: 'linear-gradient(to left, transparent 30%, rgba(0,0,0,0.7) 65%, #065f46 100%)',
                    }}
                  />
                </div>
              </div>
              ...
              <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
                <div className="grid lg:grid-cols-2 gap-8 items-center h-full py-8 lg:py-12">
                  {/* Left Content - text stays readable */}
                  <div className="text-center lg:text-left">
                    <span className="inline-block px-4 py-1.5 bg-white/20 text-white text-sm font-medium rounded-full mb-4">
                      {slide.title}
                    </span>
                    ...
                    <p className="text-base lg:text-lg text-white/90 mb-8 max-w-lg mx-auto lg:mx-0">
                      {slide.description}
                    </p>
                    <button
                      onClick={onShopNowClick}
                      className="inline-flex items-center justify-center gap-2 bg-white text-green-800 px-8 py-3.5 rounded-lg font-semibold hover:bg-green-50 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                    >
                      Shop Now
                      <ArrowRight className="h-5 w-5" />
                    </button>
                  ...
                  {/* Right side - empty on mobile, image visible on lg+ */}
